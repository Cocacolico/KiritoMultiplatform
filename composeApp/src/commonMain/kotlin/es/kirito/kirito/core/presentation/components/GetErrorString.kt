...
fun GetErrorString(error: String?): String {
   ...
   return when (errorCode) {
        0 -> stringResource(Res.string.sin_error)
        1 -> stringResource(Res.string.no_viene_token_de_usuario)
        2 -> stringResource(Res.string.token_incorrecto)
        3 -> stringResource(Res.string.petici_n_incorrecta)
        4 -> stringResource(Res.string.no_viene_petici_n_de_acci_n)
        5 -> stringResource(Res.string.petici_n_de_acci_n_no_existente)
        6 -> stringResource(Res.string.versi_n_de_la_app_obsoleta)
        7 -> stringResource(Res.string.no_viene_nombre_de_la_app)
        8 -> stringResource(Res.string.no_viene_versi_n_de_la_app)
        9 -> stringResource(Res.string.nombre_de_la_app_desconocido)
        11 -> stringResource(Res.string.usuario_o_contrase_a_incorrectos)
        12 -> stringResource(Res.string.usuario_bloqueado)
        14 -> stringResource(Res.string.usuario_desactivado)
        15 -> stringResource(Res.string.problemas_de_login_de_usuario)
        16 -> stringResource(Res.string.el_usuario_indicado_ya_existe)
        17 -> stringResource(Res.string.la_contrase_a_antigua_no_coincide)
        18 -> stringResource(Res.string.la_contrase_a_debe_tener_5_caracteres)
        150 -> stringResource(Res.string.no_hay_datos_de_turnos_ganables)
        151 -> stringResource(Res.string.no_hay_datos_de_colores_de_turnos)
        201 -> stringResource(Res.string.el_usuario_no_es_administrador)
        301 -> stringResource(Res.string.el_mensaje_no_existe)
        302 -> stringResource(Res.string.ese_mensaje_no_es_tuyo)
        601 -> stringResource(Res.string.no_se_ha_podido_analizar_el_contenido_del_fichero_pdf)
        602 -> stringResource(Res.string.no_viene_el_fichero_pdf)
        603 -> stringResource(Res.string.fichero_demasiado_grande)
        604 -> stringResource(Res.string.error_desconocido)
        701 -> stringResource(Res.string.no_viene_el_campo_con_el_identificador_de_turno)
        702 -> stringResource(Res.string.no_viene_el_campo_con_la_fecha_del_turno)
        703 -> stringResource(Res.string.no_viene_el_campo_con_el_turno)
        704 -> stringResource(Res.string.no_viene_el_campo_con_el_tipo_de_turno)
        705 -> stringResource(Res.string.no_viene_el_campo_con_las_notas_del_turno)
        706 -> stringResource(Res.string.no_viene_el_campo_con_el_nombre_del_cambio)
        707 -> stringResource(Res.string.error_con_el_id_detalle_o_fecha_no_corresponden)
        708 -> stringResource(Res.string.error_con_la_fecha_recibida_no_es_valida)
        709 -> stringResource(Res.string.error_con_el_turno_recibido_no_tiene_valor)
        710 -> stringResource(Res.string.error_con_el_tipo_de_turno_recibido_no_es_valido)
        711 -> stringResource(Res.string.error_con_la_actualizaci_n_de_datos)
        801 -> stringResource(Res.string.no_compartes_tu_cuadro_anual)
        901 -> stringResource(Res.string.error_al_hacer_la_consulta_https_a_google)
        902 -> stringResource(Res.string.error_al_decodificar_la_respuesta_json)
        1001 -> stringResource(Res.string.no_he_podido_procesar_tu_solicutud)
        1002 -> stringResource(Res.string.no_he_podido_cargar_la_clase_php_de_trabajo)
        1003 -> stringResource(Res.string.no_he_obtenido_datos_v_lidos)
        1004 -> stringResource(Res.string.error_al_obtener_datos)
        1005 -> stringResource(Res.string.error_al_enviar_el_correo_electr_nico)
        1301 -> stringResource(Res.string.error_en_el_identificador_del_receptor_del_cambio)
        1302 -> stringResource(Res.string.el_usuario_no_participa_en_el_sistema_de_cambios)
        1303 -> stringResource(Res.string.el_receptor_no_tiene_activos_los_cambios)
        1304 -> stringResource(Res.string.no_puedes_pedirte_un_cambio_a_ti_mismo)
        1305 -> stringResource(Res.string.no_he_podido_aceptar_el_cambio_contacta_con_el_administrador)
        1306 -> stringResource(Res.string.la_fecha_del_cambio_es_erronea)
        1307 -> stringResource(Res.string.fecha_del_cambio_anterior_a_hoy)
        1308 -> stringResource(Res.string.el_usuario_no_tiene_turno_para_la_fecha_indicada)
        1309 -> stringResource(Res.string.el_destinatario_no_tiene_turno_para_la_fecha_indicada)
        1310 -> stringResource(Res.string.ya_tienes_una_petici_n_de_cambio_para_ese_usuario_y_dia)
        1311 -> stringResource(Res.string.identificador_de_cambio_erroneo)
        1312 -> stringResource(Res.string.el_estado_indicado_no_es_v_lido)
        1313 -> stringResource(Res.string.esta_petici_n_est_en_un_estado_final_y_no_se_puede_modificar)
        1314 -> stringResource(Res.string.tienes_que_responder_a_la_petici_n_del_usuario_al_que_pides_el_cambio_antes_de_hacerle_una_nueva_petici_n)
        1315 -> stringResource(Res.string.los_datos_de_la_petici_n_de_cambio_no_coindicen_con_los_almacenados_en_las_tablas_de_detalles_de_turnos)
        1321 -> stringResource(Res.string.la_fecha_indicada_para_el_anuncio_es_erronea)
        1322 -> stringResource(Res.string.el_t_tulo_indicado_no_es_v_lido)
        1323 -> stringResource(Res.string.la_explicaci_n_indicada_no_es_v_lida)
        1324 -> stringResource(Res.string.el_id_de_anuncio_no_corresponde_con_el_usuario)
        1325 -> stringResource(Res.string.ya_tiene_anuncio_previo_para_la_fecha_indicada)
        1326 -> stringResource(Res.string.la_fecha_del_anuncio_no_puede_ser_anterior_a_hoy)
        10001 -> stringResource(Res.string.versi_n_de_la_app_a_punto_de_caducar)
        10011 -> stringResource(Res.string.la_fecha_recibida_no_tiene_el_formato_y_m_d_ej_2022_12_1)
        10012 -> stringResource(Res.string.la_fecha_recibida_no_tiene_el_formato_y_m_d_h_i_s_ej_2022_12_1_14_33_12)
        10013 -> stringResource(Res.string.la_fecha_recibida_no_tiene_el_formato_m_y_ej_10_2022)
        10014 -> stringResource(Res.string.la_fecha_recibida_no_tiene_el_formato_y_ej_2022)
        10021 -> stringResource(Res.string.el_margen_de_fecha_no_es_v_lido)
        10031 -> stringResource(Res.string.no_puedo_devolver_imagen_ya_que_no_hay_gr_fico_para_la_fecha_indicada)
        10032 -> stringResource(Res.string.no_hay_imagen_para_el_turno_y_fecha_recibidos)
        10033 -> stringResource(Res.string.no_hay_nombre_de_fichero_para_el_turno_y_fecha_recibidos)
        10034 -> stringResource(Res.string.no_encuentro_el_fichero_en_el_directorio)
        10101 -> stringResource(Res.string.el_fichero_adjunto_supera_los_20mb_no_se_guarda)

        else -> "Error. Código: $error"
    }
}